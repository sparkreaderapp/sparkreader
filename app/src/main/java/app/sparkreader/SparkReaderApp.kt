...
* (This file was originally named GalleryApp.kt)
*/
...
import app.sparkreader.ui.navigation.SparkReaderNavHost

/** Top level composable representing the main screen of the application. */
@Composable
fun SparkReaderApp(navController: NavHostController = rememberNavController()) {
  SparkReaderNavHost(navController = navController)
}
