...
data class AllowedModel(
  ...
  val modelDownloadLink: String? = null,
) {
  fun toModel(): Model {
    // Use modelDownloadLink if available, otherwise construct HF download url
    val downloadUrl = modelDownloadLink ?: "https://huggingface.co/$modelId/resolve/main/$modelFile?download=true"
    ...
    return Model(
      ...
      modelLink = "https://huggingface.co/${modelId}",
